                        ...
                        if let Some(org) = selected_org.get() {
                                        ...
                                        view! {
                                            <div class="w-5 h-5 bg-blue-500 rounded flex items-center justify-center">
                                                <span class="text-white text-xs font-bold">
                                                    {org.name.chars().next().unwrap_or('O').to_uppercase().to_string()}
                                                </span>
                                            </div>
                                        }.into_any()
                                    }}
                            ...
                            view! {
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-neutral-500 dark:text-neutral-400">No Organization</span>
                                ...
                                view! {
                                    <div class="w-full">
                                            ...
                                            <For
                                                ...
                                                children=move |org: Organization| {
                                                    ...
                                                    let is_selected = move || {
                                                        selected_org.get().map(|s| s.id.to_string() == org.id.to_string()).unwrap_or(false)
                                                    };
                                                    view! {
                                                        <DropdownItem
                                        ...
                                        <div class="py-1 w-full min-w-96">
                                            <DropdownItem
                                                href="/settings/organizations".into()
                                            >
