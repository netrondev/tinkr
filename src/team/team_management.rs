    ...
    view! {
        <div>
            <div class="flex justify-between items-center mb-4">
                ...
                >
                    <span class="w-4 h-4 mr-2"><Icon icon=USER_PLUS size="16" /></span>
                    "Create Team"
                </button>
            </div>
                                                                ...
                                                                <div class="flex items-center space-x-2">
                                                                    <span class="text-sm text-neutral-600 dark:text-neutral-400 flex items-center">
                                                                        {match member.role {
                                                                            TeamRole::Owner => view! {
                                                                                <>
                                                                                    <span class="w-4 h-4 mr-1 text-yellow-500"><Icon icon=CROWN size="16" /></span>
                                                                                    "Owner"
                                                                                </>
                                                                            }.into_any(),
                                                                            TeamRole::Admin => view! {
                                                                                <>
                                                                                    <span class="w-4 h-4 mr-1 text-blue-500"><Icon icon=SHIELD_CHECK size="16" /></span>
                                                                                    "Admin"
                                                                                </>
                                                                            }.into_any(),
                                                                            TeamRole::Member => view! {
                                                                                <>
                                                                                    <span class="w-4 h-4 mr-1 text-neutral-500"><Icon icon=USER size="16" /></span>
                                                                                    "Member"
                                                                                </>
                                                                            }.into_any(),
                                                                        }}
                                                                    ...
                                                                    <Show when=move || member.role != TeamRole::Owner>
                                                                        <button
                                                                            on:click={
                                                                                ...
                                                                                let user_id = user_id.clone();
                                                                                move |_| {
                                                                                    remove_member_action.dispatch((team_id_clone.clone(), user_id.clone()));
                                                                                }
                                                                            }
